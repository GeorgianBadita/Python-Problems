...
class UI:
    ...
    def __list_rentals(self):
        ...
        if rental_list is None:
            ...
            for rt in rental_list:
                print(rt[0].get_car_model() + " was rented by " + rt[1].get_cl_name())
    ...
    def __add_data(self):
        ...
        rt1 = self.__rt_serv.add_rent_srv(4, 5)
        rt1 = self.__rt_serv.add_rent_srv(1, 2)
        rt1 = self.__rt_serv.add_rent_srv(3, 4)
